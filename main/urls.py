...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        #沙箱接口
        if tableName.lower()=="hangqinginfo":
            urlpatterns.extend(
                  [
        ...
        if tableName.lower()=="purchaseinfo":
            urlpatterns.extend(
                  [
                  path(r'{}/value/<xColumnName>/<yColumnName>/<timeStatType>'.format(tableName.lower()),
                       eval("{}_v.{}_value".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "gongyingshang":
            urlpatterns.extend(
                [
        ...
        if tableName.lower() == "shuiguoxinxi":
            urlpatterns.extend(
                [
                    path(r'<tableName>/remind/<columnName>/<type>',eval("{}_v.{}_remind".format(tableName.capitalize(), tableName.lower())))
                ]
            )
        if tableName.lower() == "shuiguobaojia":
            urlpatterns.extend(
                [
                    path(r'{}/shBatch'.format(tableName.lower()),
                         eval("{}_v.{}_shBatch".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "gongyingshangkucun":
            urlpatterns.extend(
                [
                    path(r'<tableName>/remind/<columnName>/<type>',eval("{}_v.{}_remind".format(tableName.capitalize(), tableName.lower())))
                ]
...
#预测
        if tableName.lower() == "hangqinginfoforecast":
            urlpatterns.extend(
                       [
