...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spider622az270 && scrapy crawl "+tableName+"Spider -a databaseName=fruitShop"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=fruitShop"
        os.system(cmd)
